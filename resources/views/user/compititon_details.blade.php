...
?>    
								...
								<a class="example-image-link" href="{{$videos[$i]}}" data-lightbox="example-set" data-title="Uploaded By : {{$user->user_name}}  Description : {{$user->compotition_details}} "><video width="320" height="240"  style="max-width: 100%;" poster="{{ asset('assets/images/preview.jpeg')}}" controls playsinline><source src="{{$videos[$i]}}" type="video/mp4">Your browser does not support the video tag.</video></a>
								<!-- <img class="img-responsive" src="{{$images[$i]}}" style="width:70px;height:70px;" alt="Img" style="width:500px;height:500px"> -->
