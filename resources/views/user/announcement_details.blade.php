								...
								<div class="blog-share" style="display:flex;position: relative;">
									<div class="row" style="border: 3px solid #d4d4d4;
										...
										@if(sizeof($like_status)>0)
											<a href="/deleteNewslike/{{ Auth::user()->id }}/{{$announcement->id}}" ><i style="font-size: 39px;color: white;" class="fa fa-heart heart"></i></a>
										@else
											<a href="/addNewslike/{{ Auth::user()->id }}/{{$announcement->id}}"><i style="font-size: 39px;color: white;" class="fa fa-heart-o" aria-hidden="true"></i></a> 
										@endif
										</div>
