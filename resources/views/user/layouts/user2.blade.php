...
function addChild() {
	...
	$("#items").append('<div class="col-xs-12 col-sm-12"><div class="form-group"><input type="email" name="member_email[]" class="form-control" placeholder="Your member Email" required="required"></div></div>');
    ...
    // $("#items").append('<div class="col-xs-12 col-sm-12"><div class="form-group"><label class="radio-inline"><input type="radio" name="member_gender[]" value="male"  >Male</label><label class="radio-inline"><input type="radio" name="member_gender[]" value="female" >Female </label></div></div>');
    let increment=parseInt(child_number)+1;
