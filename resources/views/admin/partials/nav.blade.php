          ...
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <!-- <ul class="nav navbar-nav float-right">
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">IOCL Admin</span><span class="user-status">Available</span></div><span><img class="round" src="../../../app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span></a>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="#"><i class="feather icon-cpu"></i><span class="menu-title" data-i18n="Ecommerce">Ushare</span></a>
            <ul class="menu-content">
              ...
              <li><a href="/admin/ushare/pending"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Pending Ushares List</span></a></li>
              </ul>
          </li>
          ...
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Ecommerce">Users</span></a>
            <ul class="menu-content">
              ...
              <li><a href="/user"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">View user</span></a>
              </li>
            </ul>
          </li>
          <li><a href="/banner"><i class="feather  icon-list "></i><span class="menu-item" data-i18n="Shop">Banner</span></a>
          <li class=" navigation-header"><span>Ecommerce</span>
          </li>
        <li><a href="/category"><i class="feather  icon-list "></i><span class="menu-item" data-i18n="Shop">Category</span></a>
              </li>
              <li><a href="/group"><i class="feather icon-server "></i><span class="menu-item" data-i18n="Shop">Group</span></a>
              </li>
              <li><a href="/attribute"><i class="feather icon-copy"></i><span class="menu-item" data-i18n="Shop">Attribute</span></a>
              </li>
            
          <li class=" nav-item"><a href="#"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Ecommerce">Product</span></a>
            <ul class="menu-content">
              <li><a href="/product/create"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Add Product</span></a>
              </li>
              <li><a href="/product"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">View Product</span></a>
              </li>
            </ul>
          </li> -->

          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-mail"></i><span class="menu-title" data-i18n="Ecommerce">Contact</span></a>
            <ul class="menu-content">
              <li><a href="/contact/formal_representators"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Formal Representators</span></a>
              </li>
              <li><a href="/contact"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Update contact</span></a>
              </li>
            </ul>
          </li> -->
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="Ecommerce">Business Hours</span></a>
            <ul class="menu-content"> -->
              <!-- <li><a href="/business_hours"><i class="feather icon-clock"></i><span class="menu-item" data-i18n="Details">Business Hours</span></a>
              </li> -->
            <!-- </ul>
          </li> -->
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="Ecommerce">Home Category</span></a>
            <ul class="menu-content"> -->
              <!-- <li><a href="/category_product"><i class="feather icon-globe"></i><span class="menu-item" data-i18n="Details">Home Category</span></a>
              </li> -->
            <!-- </ul>
          </li> -->
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="Ecommerce">Gift Products</span></a>
            <ul class="menu-content"> -->
              <!-- <li><a href="/gift_products"><i class="feather icon-gift"></i><span class="menu-item" data-i18n="Details">Gift Products</span></a>
              </li> -->
            <!-- </ul>
          </li> -->
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="Ecommerce">Offer Products</span></a>
            <ul class="menu-content"> -->
              <!-- <li><a href="/offer_products"><i class="feather icon-percent"></i><span class="menu-item" data-i18n="Details">Offer Products</span></a>
              </li> -->
            <!-- </ul>
          </li> -->
          <!-- <li class=" nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="Ecommerce">Orders</span></a>
            <ul class="menu-content"> -->
              <!-- <li><a href="/order"><i class="feather icon-archive"></i><span class="menu-item" data-i18n="Details">Orders</span></a>
              </li>
              <li><a href="/send_push_notification"><i class="feather icon-bell"></i><span class="menu-item" data-i18n="Details">Send Push Notification</span></a>
              </li> -->
            <!-- </ul>
          </li> -->
          <!-- <li class=" navigation-header"><span>Apps</span>
