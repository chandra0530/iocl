                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" method="POST"
                                              action="{{ route('compititions.update',$competitions->id) }}">
                                            
                                            @csrf
                                            <input type="hidden" name="_method" value="PUT">
                                            <input type="hidden" name="competition_id" value="{{$competitions->id}}">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea id="desc" name="desc"
                                                                  style="height: 500px; width: 100%" required>{{$competitions->competition_details}}</textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
